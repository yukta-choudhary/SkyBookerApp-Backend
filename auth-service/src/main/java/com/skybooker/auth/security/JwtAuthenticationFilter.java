    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            if (tokenBlacklistService.isBlacklisted(jwt)) {
                log.warn("Blacklisted token used for path={}", request.getRequestURI());
                filterChain.doFilter(request, response);
                return;
            }
            ...
            log.warn("Invalid JWT for path={} reason={}", request.getRequestURI(), ex.getMessage());
        } catch (Exception ex) {
            log.error("Unexpected error while processing JWT for path={}", request.getRequestURI(), ex);
        }
