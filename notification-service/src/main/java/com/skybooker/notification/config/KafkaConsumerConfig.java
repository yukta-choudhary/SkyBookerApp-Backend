...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, PaymentSuccessEvent> paymentSuccessConsumerFactory() {
        ...
        deserializer.addTrustedPackages("com.skybooker.*");
    ...
    @Bean
    public ConsumerFactory<String, FlightStatusChangedEvent> flightStatusConsumerFactory() {
        JsonDeserializer<FlightStatusChangedEvent> deserializer = new JsonDeserializer<>(FlightStatusChangedEvent.class);
        deserializer.addTrustedPackages("com.skybooker.*");
        deserializer.setUseTypeHeaders(false);
        Map<String, Object> props = baseConsumerProps();
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, deserializer);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, FlightStatusChangedEvent>
    flightStatusKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, FlightStatusChangedEvent> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(flightStatusConsumerFactory());
        return factory;
    }
}
